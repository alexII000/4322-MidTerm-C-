...
class DinnerPlanner:
    def __init__(self):
        ...
        self.dateRB2 = tkinter.Radiobutton(self.frame8,text='March 2 2023',value='3/2/23')
        self.dateRB3 = tkinter.Radiobutton(self.frame8,text='March 3 2023',value='3/3/23')
        ...
        self.submitButton = tkinter.Button(self.frame13,text="Submit",command=self.show_choice)
        self.dummyLabel6 = tkinter.Label(self.frame13,text="",width=20)
        self.cancelButton = tkinter.Button(self.frame13,text="Cancel",command=self.frame13.destroy)
